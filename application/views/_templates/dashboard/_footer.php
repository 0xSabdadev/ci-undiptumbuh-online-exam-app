			...
			<footer class="main-footer">
				...
				<!-- Default to the left -->
				<div>
					<p style="font-size: 14px;color:#999999">Undip Tumbuh Web Application</p>
					<p style="font-size: 14px;font-weight: 700;color:#869099">&copy; <?php echo date('Y')?> - Online Exam System in PHP using CI . All rights reserved</p>
				</div>
				<!-- <strong>&copy; <?php echo date('Y')?> - Project PBP - Kelompok 6 . </strong> <br> All rights reserved -->
			</footer>
